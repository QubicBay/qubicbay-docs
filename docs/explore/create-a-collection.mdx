...
<Tabs groupID="Create a Collection">
  ...
  <TabItem value="Normal" label="Normal Collection">
    ...
    > **⚠️ WARNING:** For normal collections, the creator must add the attributes/traits manually. Unlike drop collections where attributes are automatically generated from metadata, normal collections require you to manually configure each NFT's traits and attributes after minting.
    
    ![Select Collection](/img/qubicbay/Screenshot_58.png)
