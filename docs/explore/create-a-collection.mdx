...
<Tabs groupID="Create a Collection">
    ...
    <TabItem value="Normal" label="Normal Collection">
        ...
        1. **Navigate to Collections**: Go to your account dashboard
        2. **Select Create**: Choose the normal collection option
        3. **Configure Settings**: Set up your collection parameters
        4. **Add Assets**: Upload your NFT files
        5. **Publish**: Make your collection live
